...
Centralenheten har fölajnde två lägen:

\begin{enumerate}
    \item Standardläge: Enheten väntar på larm-meddelanden från periferienheterna eller användarinput via USART. Dessutom skickar den regelbundet  konfigurationen för anslutna dörrar och sensorer. Periferienheten bekräftar konfigurationen. Om den inte svarar efter ett antal meddelanden går larmet.
