...
Vibrationssensorn har endast central larm som skickas via CAN.
 ...
 en dörrenhet, en rörelse enhet och en centralenhet. De olika enheterna kommunicerar via CAN. Både dörrenheten och rörelseenheten kan skicka centrala larm till centralenheten efter en tid som man kan ställa in via centralenheten. Ifall en enhet försvinner ifrån
 nätverket märks detta och användaren varnas. Tester visar med god säkerhet att larmmeddelanden når centralenheten även med mycket brus på CAN-bussen.
