...
Utöver de ovan nämnda testerna så är centralenheten involverad i alla dem testarna som inkluderar kommunikation mellan enheter. Och även här i de systemövergirpande testerna (\ref{test:brusTest} och \ref{test:replayer}) har centralenheten presterat som förväntat. Centralenheten har klarata av att sköta kommunikationen med periferienheter trots mycket traffik på CAN-bussen och även förhindrat återuppspelningsattack genom session id. Allt som allt ger det en centralenhet som klarar av det som förväntas, dock skulle man önska ett mer användarvänligt kommandogränssnitt då detta upplevs som klumpigt.
