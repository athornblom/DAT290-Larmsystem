...
\appendix
    ...
    \label{kommandon}
        För att styra centralenheten används ett antal kommandon som är breskrivna nedan. Då centralenheten har två separata lägen
    ...
    \textbf{dor v x y z}\\
    Där \textbf{v, x, y} och \textbf{z} är tal mellan 0 och 9. konfigurerar dörr \textbf{x} på enhet med ID \textbf{v} med timer för lokalt larm på  \(\textbf{y} * 10\) sekunder samt en fördröjning till centraltlarm på \(\textbf{z} * 10\) sekunder.
