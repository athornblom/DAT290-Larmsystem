...
\begin{description}
    \item[Startläge] I detta läge accepterar centralenhetern sammankoppling med periferienheter genom att lyssna på ID-begäransmeddelanden och därefter tilldela ID-adresser.
...
Ifrån båda lägena kan användaren hantera periferienheterna genom konfigurationsändringar. För de lössenordsskyddade kommandona används en knappsats som låter användaren användaren logga in med en fyrasiffrig pinkod. 
