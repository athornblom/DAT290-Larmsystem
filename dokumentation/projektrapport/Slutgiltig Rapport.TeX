...
Rörelseenheten klarar av  exekvera kod för flertalet vibrations- och rörelsesensorer samtidigt, upp till 23 sensorer,
...
Tidigt i projektets gång var man tvungen att välja mellan polling eller avbrott för att respondera på externa händelser för dörr- och rörelseenheten.  Polling valdes dels för att koden blir lättare att förstå och underhålla, men även för att tanken med systemet är att inget larm ska ha högre prioritet än någon annan larm.

Skulle man valt att implementera mjukvaran för dörrenheten med avbrott är den enda fördelen att man hade kunnat dela upp dörrarna så att de hade olika prioritet när de larmar, vilket skulle kunna resultera i att vissa larm skulle kommit fram till centralenheten snabbare än de hade med polling. Men tiden man tjänar in hade handlat om millisekunder, och eftersom MD407-enkortsdatorn endast stöttar 16 avbrottslinor skulle man ändå behöva använda sig av någon form av polling ifall man vill ha mer än 16 dörrar. Det är heller inte säkert att avbrott hade gått snabbare då kontextbyten också tar tid. Prestandatestet som utfördes visade inte på någon märkbar fördröjning, så valet med polling känns högst befogat,  se bilaga \ref{test:prestandaTest}.
