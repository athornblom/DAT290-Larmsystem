...
Projekets syfte är att utveckla ett larmsystemets som ska vara ett finansiellt dynamiskt alternativ för företag \todo{Lång mening}
...
\todo{SystemTimer särskrivs i arbetsmetod, och inte här}
...
\todo{Lokala larmavståndet beräknas på rörelseenheten}
...
\todo{Kanske bara behöver nämna alternativa lösningar i diskussion}
