...
och port D och E till vibrationssensorerna. Dock är vissa pinnar på port A och B tilldelade till bland annat 
CAN och USART. Dessa pinnar går ej att sätta sensorer på, se dzhthtzh.
...
\begin{table}[htbp]
	...
	\begin{tabular}{|c|c} \hline
		...
		GPIOB & 10 \\ \hline
	\end{tabular}
	\caption{GPIO-pinnar på port A och B som ej går att använda.}
