...
Ett centralt uppkopplat larmsystem är en produkt som är väldigt
effektivt för att kunna upptäcka pågående inbrott så snabbt
som möjligt. Inte för att glömma att ett centralt uppkopplat
larmsystem även kan avskräcka personer ifrån att göra olaga 
intrång. Eftersom att Rekomendationen enligt 
stöldskyddsföreningen\cite{SSF} är att ha ett 
larm som är uppkopplat till en larmcentral, har grupp13 (insert cool name)
valt att utveckla en del av ett uppkopplat larmsystem.

Systemets uppgift är att öka säkerheten och översikten av
kundens lokaler, genom att larma önskade dörrar. Säkerheten 
ökas då i systemet eftersom att ifall en dörr är öppen längre
än en tid som kunden själv väljer, så larmar den dörren centralt,
vilket gör att det upptäckts så fort som möjligt. Säkerheten
kan även ökas genom att kompletera med våra rörelse och vibrationsensorer
som även dem är uppkopplade, för att detektera rörelse eller vibrationer.
...
Vår del utav larmsystemet ska bestå utav tre typer av enheter.
\begin{itemize}
    \item Centralenhet 
\end{itemize}
