...
## Objects
##
$(IntermediateDirectory)/up_lib_STM32F4_lib_STM32F4xx_StdPeriph_Driver_src_stm32f4xx_usart.c$(ObjectSuffix): ../lib/STM32F4_lib/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_usart.c $(IntermediateDirectory)/up_lib_STM32F4_lib_STM32F4xx_StdPeriph_Driver_src_stm32f4xx_usart.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/git/DAT290-Larmsystem/kod/lib/STM32F4_lib/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_usart.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/up_lib_STM32F4_lib_STM32F4xx_StdPeriph_Driver_src_stm32f4xx_usart.c$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/up_lib_STM32F4_lib_STM32F4xx_StdPeriph_Driver_src_stm32f4xx_usart.c$(DependSuffix): ../lib/STM32F4_lib/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_usart.c
	@$(CC) $(CFLAGS) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/up_lib_STM32F4_lib_STM32F4xx_StdPeriph_Driver_src_stm32f4xx_usart.c$(ObjectSuffix) -MF$(IntermediateDirectory)/up_lib_STM32F4_lib_STM32F4xx_StdPeriph_Driver_src_stm32f4xx_usart.c$(DependSuffix) -MM ../lib/STM32F4_lib/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_usart.c

$(IntermediateDirectory)/up_lib_STM32F4_lib_STM32F4xx_StdPeriph_Driver_src_stm32f4xx_usart.c$(PreprocessSuffix): ../lib/STM32F4_lib/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_usart.c
	$(CC) $(CFLAGS) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/up_lib_STM32F4_lib_STM32F4xx_StdPeriph_Driver_src_stm32f4xx_usart.c$(PreprocessSuffix) ../lib/STM32F4_lib/STM32F4xx_StdPeriph_Driver/src/stm32f4xx_usart.c

$(IntermediateDirectory)/up_lib_buffer.c$(ObjectSuffix): ../lib/buffer.c $(IntermediateDirectory)/up_lib_buffer.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/git/DAT290-Larmsystem/kod/lib/buffer.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/up_lib_buffer.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/up_lib_STM32F4_lib_STM32F4xx_StdPeriph_Driver_src_misc.c$(ObjectSuffix): ../lib/STM32F4_lib/STM32F4xx_StdPeriph_Driver/src/misc.c $(IntermediateDirectory)/up_lib_STM32F4_lib_STM32F4xx_StdPeriph_Driver_src_misc.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/git/DAT290-Larmsystem/kod/lib/STM32F4_lib/STM32F4xx_StdPeriph_Driver/src/misc.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/up_lib_STM32F4_lib_STM32F4xx_StdPeriph_Driver_src_misc.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/up_lib_USART.c$(ObjectSuffix): ../lib/USART.c $(IntermediateDirectory)/up_lib_USART.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/git/DAT290-Larmsystem/kod/lib/USART.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/up_lib_USART.c$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/up_lib_USART.c$(DependSuffix): ../lib/USART.c
	@$(CC) $(CFLAGS) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/up_lib_USART.c$(ObjectSuffix) -MF$(IntermediateDirectory)/up_lib_USART.c$(DependSuffix) -MM ../lib/USART.c

$(IntermediateDirectory)/up_lib_USART.c$(PreprocessSuffix): ../lib/USART.c
	$(CC) $(CFLAGS) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/up_lib_USART.c$(PreprocessSuffix) ../lib/USART.c
